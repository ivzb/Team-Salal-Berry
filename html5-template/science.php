            ...
            <div class="row science1">
               ...
               <div class="col-md-4">
                  <h2>Изследвания относно фантазии</h2>
                   <p>
                       <img src="images/web-fantasy.jpg" />
                   </p>
               </div>
            </div>
             ...
             <div class="row science1">
                 ...
                 <div class="col-md-4">
                     ...
                     <p>
                         <img src="images/brightness.jpg" />
                     </p>
                 </div>
                 <div class="col-md-4">
                    <h2>Първият ден</h2>
                     <p>
                         <img src="images/first-work-day.jpg" />
                     </p>
             ...
             <div class="row science3">
               ...
               <div class="row science8">
                 <div class="col-md-4">
                     <h2>3D МОДЕЛ</h2>
                     <p>
                         <img src="images/save-icon.jpg" />
                     </p>
                 </div>
                 <div class="col-md-4">
                     <h2>Влиянието на родителите над децата</h2>
                     <p>
                         <img src="images/play_outside2.jpg" />
                     </p>
                 </div>
                 <div class="col-md-4">
                 ...
                 <div class="col-md-4">
                     <h2>НАЧИНЪТ</h2>
                     <p>
                         <img src="images/kill-life.jpg" />
                     </p>
                 </div>
                 <div class="col-md-4">
                     <h2>Първият ден ЖИВОТ</h2>
                     <p>
