      ...
      <section>
         <div class="container">
             <div class="row long">
                 ...
                 <div class="col-md-6">
                     <img src="http://greenuni.cloudvps.bg/images/about-us.png" class="right" alt="" />
                 </div>
             </div>
            ...
            <div class="row about">
               <div class="col-md-4">
                  ...
                  <p>
                      <img class="fancybox" src="http://greenuni.cloudvps.bg/images/working-at-it-department.jpg" alt="" />
                  </p>
               </div>
               <div class="col-md-4">
                  ...
                  <p>
                   ...
                   <p>
                       <img class="fancybox" src="http://greenuni.cloudvps.bg/images/education-quality.jpg" alt="" />
                   </p>
               </div>
               <div class="col-md-4">
                  <h2>Развитие</h2>
                  <p>
                   ...
                   <p>
                       <img class="fancybox" src="http://greenuni.cloudvps.bg/images/progress.png" alt="" />
                   </p>
               </div>
            </div>
             ...
             <div class="row">
                 <div class="col-md-4">
                     ...
                     <p>
                         <img class="fancybox" src="http://greenuni.cloudvps.bg/images/europe-integration.jpg" alt="" />
                     </p>
                 </div>
                 <div class="col-md-4">
                     ...
                     <p>
                         <img class="fancybox" src="http://greenuni.cloudvps.bg/images/facilities.jpg" alt="" />
                     </p>
                 </div>
                 <div class="col-md-4">
                     ...
                     <p>
                         <img class="fancybox" src="http://greenuni.cloudvps.bg/images/ecology.jpg" alt="" />
                     </p>
                 </div>
             </div>
