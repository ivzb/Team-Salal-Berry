...
<section>
    <div class="container">
        <div class="row long">
            ...
            <div class="col-md-6">
                <img src="http://greenuni.cloudvps.bg/images/speciality_2.jpg" class="right" alt="" />
            </div>
        </div>
        ...
        <div class="row majors">
            <div class="col-md-4">
                ...
                <p>
                    <img class="fancybox" src="http://greenuni.cloudvps.bg/images/redroses.jpg" alt=""  />
                </p>
            </div>
            <div class="col-md-4">
                <h2>Цветово кодиране на скрити послания с цветни лехи</h2>
                <p>
                    <img class="fancybox" src="http://greenuni.cloudvps.bg/images/promotion.jpg" alt="" />
                </p>
            </div>
            <div class="col-md-4">
                <h2>Хардуер за поддържане на оптимални условия за растеж</h2>
                <p>
                    <img class="fancybox" src="http://greenuni.cloudvps.bg/images/plant.jpg" alt="" />
                </p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <p>
                    <img class="fancybox" src="http://greenuni.cloudvps.bg/images/planting.jpg" alt="" />
                </p>
            </div>
            <div class="col-md-4">
                <h2>Архитектурен дизайн на зелени площи</h2>
                <p>
                    <img class="fancybox" src="http://greenuni.cloudvps.bg/images/architecture_design.jpg" alt="" />
                </p>
            </div>
            <div class="col-md-4">
                <h2>Тестване мекотата на тревните площи в бизнес сграда</h2>
                <p>
                    <img class="fancybox" src="http://greenuni.cloudvps.bg/images/testing.jpg" alt="" />
                </p>
            </div>
        </div>
