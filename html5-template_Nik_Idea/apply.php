...
<section>
    <div class="container">
        <div class="row long">
            ...
            <div class="col-md-6">
                <img src="http://greenuni.cloudvps.bg/images/apply.jpg" class="right" alt=""  />
            </div>
        </div>
        ...
        <div class="row apply">
            <div class="col-md-4">
                ...
                <p>
                    <img class="fancybox" src="http://greenuni.cloudvps.bg/images/nakov-award.jpg" alt=""  />
                </p>
            </div>
            <div class="col-md-4">
                ...
                <p>
                    <img class="fancybox" src="http://greenuni.cloudvps.bg/images/greening-course.jpg" alt=""  />
                </p>
            </div>
            <div class="col-md-4">
                <h2>Приемен изпит</h2>
                ...
                <p>
                    <img class="fancybox" src="http://greenuni.cloudvps.bg/images/grass-laptop.jpg" alt=""  />
                </p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <p>
                    <img class="fancybox" src="http://greenuni.cloudvps.bg/images/destinguish.jpg" alt=""  />
                </p>
            </div>
            <div class="col-md-4">
                ...
                <p>
                    <img class="fancybox" src="http://greenuni.cloudvps.bg/images/hacker.jpg" alt=""  />
                </p>
            </div>
        </div>
